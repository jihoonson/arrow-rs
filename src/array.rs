...
extern "C" {
  ...
  pub fn arr_type(arr: *const Array) -> RawDataTypePtr;
  pub fn arr_type_enum(arr: *const Array) -> Ty;
  ...
  pub fn new_null_arr(ty: RawDataTypePtr, length: i32) -> *const Array;
