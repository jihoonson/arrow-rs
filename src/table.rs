...
extern "C" {
  // RowBatch
  pub fn new_row_batch(schema: ty::RawSchemaPtr, num_rows: i32, arrays: &[*const array::Array], arr_len: i32) -> *const RowBatch;
  ...
  // Table
  pub fn new_table(name: *const libc::c_char, schema: ty::RawSchemaPtr, cols: &[*const column::Column], num_cols: i32) -> *const Table;
